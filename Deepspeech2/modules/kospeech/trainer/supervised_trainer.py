...
from modules.kospeech.checkpoint import Checkpoint
from modules.kospeech.metrics import CharacterErrorRate
from modules.kospeech.utils import logger
from modules.kospeech.criterion import (
    LabelSmoothedCrossEntropyLoss,
    JointCTCCrossEntropyLoss,
)
from modules.kospeech.data import (
    MultiDataLoader,
    AudioDataLoader,
    SpectrogramDataset,
)
...
class SupervisedTrainer(object):
    ...
    def train(
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            print('Epoch %d CER %0.4f' % (epoch, valid_cer))
