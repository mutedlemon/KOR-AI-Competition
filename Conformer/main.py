...
if __name__ == '__main__':
    ...
    args.add_argument('--seed', type=int, default=777) # 3045, 9790,
    ...
    args.add_argument('--lr_scheduler', type=str, default='transformer_lr_scheduler') # changed
    args.add_argument('--total_steps', type=int, default=200000)
    args.add_argument('--decay_steps', type=int, default=100000) # changed
    ...
    # Conformer arguments
    args.add_argument('--encoder_dim', type=int, default=512) # changed
    args.add_argument('--decoder_dim', type=int, default=640) # changed
    args.add_argument('--num_decoder_layers', type=int, default=1) #changed
    ...
    args.add_argument('--num_attention_heads', type=int, default=4) # changed
    args.add_argument('--feed_forward_expansion_factor', type=int, default=4) # changed
    args.add_argument('--conv_expansion_factor', type=int, default=2) # changed
    args.add_argument('--input_dropout_p', type=float, default=0.1) # changed
    args.add_argument('--feed_forward_dropout_p', type=float, default=0.1) # changed
    args.add_argument('--attention_dropout_p', type=float, default=0.1) # changed
    args.add_argument('--conv_dropout_p', type=float, default=0.1) # changed
    args.add_argument('--conv_kernel_size', type=int, default=31) # changed
    args.add_argument('--half_step_residual', type=bool, default=True) # changed


    args.add_argument('--audio_extension', type=str, default='pcm')
    args.add_argument('--transform_method', type=str, default='fbank')
    args.add_argument('--feature_extract_by', type=str, default='librosa') # changed
